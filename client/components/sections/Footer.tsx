        ...
        <div className="footer-container max-w-6xl mx-auto">
          ...
          <div className="footer-top grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 pb-16 border-b border-white/10">
            ...
            <div className="footer-brand">
              ...
              <p className="footer-tagline text-white/70 text-sm leading-relaxed mb-6">
                Your ultimate college fest experience platform. Celebrating
                talent, creativity, and innovation since day one.
              </p>
              <div className="footer-social-preview flex gap-3">
                <a
                  href="#"
                  className="social-icon-mini p-2 rounded-lg bg-white/10 hover:bg-primary transition-colors"
                >
                  <Facebook size={18} />
                </a>
                <a
                  href="#"
                  className="social-icon-mini p-2 rounded-lg bg-white/10 hover:bg-accent transition-colors"
                >
                  <Instagram size={18} />
                </a>
              </div>
            ...
            <div className="footer-links">
              <h4 className="footer-section-title font-bold mb-6 text-lg">
                Navigation
              </h4>
              <ul className="footer-link-list space-y-3">
                <li>
                  <a
                    href="#home"
                    className="footer-link text-white/70 hover:text-white transition-colors inline-flex items-center gap-2"
                  >
                    <span>→</span> Home
                  </a>
                </li>
              ...
              <ul className="footer-contact-list space-y-4">
                <li className="footer-contact-item flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@festsphere.com"
            ...
            <div className="footer-social">
              ...
              <div className="footer-social-links flex flex-col gap-3">
                <a
                  href="#"
                  className="footer-social-link flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-primary/20 transition-colors border border-white/10 hover:border-primary/50"
                >
                  <Facebook size={20} />
                ...
                <a
                  href="#"
                  className="footer-social-link flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-accent/20 transition-colors border border-white/10 hover:border-accent/50"
                >
                  <Twitter size={20} />
                ...
                <a
                  href="#"
                  className="footer-social-link flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-pink-500/20 transition-colors border border-white/10 hover:border-pink-500/50"
                >
                  <Instagram size={20} />
                ...
                <a
                  href="#"
                  className="footer-social-link flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-blue-500/20 transition-colors border border-white/10 hover:border-blue-500/50"
                >
                  <Linkedin size={20} />
          ...
          <div className="footer-bottom flex flex-col sm:flex-row justify-between items-center gap-6 pt-8">
            <p className="footer-copyright text-white/60 text-sm flex items-center gap-2">
              © {currentYear} FestSphere. Made with{" "}
              <Heart size={16} className="text-accent fill-current" /> by the
              events team.
            </p>
