    ...
    <div className="min-h-screen bg-gradient-to-br from-primary via-blue-600 to-accent flex items-center justify-center px-4">
      <div className="text-center text-white max-w-md">
        ...
        <p className="text-lg mb-8 text-white/90">
          Oops! The page you're looking for doesn't exist. This could be a new
          feature we're building or it might have moved.
        </p>
        <Link to="/">
          <Button
            size="lg"
        ...
        <p className="mt-8 text-sm text-white/70">
          Want to help us build more pages? Keep prompting for the content you
          need!
        </p>
      </div>
    </div>
